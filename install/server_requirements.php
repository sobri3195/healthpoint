...
################################################################################
	...
	$validations = array(
		...
		'database_extension' => array(false, lang_key('database_extension').' (mysqli)', extension_loaded('mysqli'), lang_key('enabled'), lang_key('disabled')),
    ...
    if(EI_CHECK_EXTENSIONS){
        ...
        $validations['php_gd'] = array(false, 'PHP GD', in_array('gd', $loaded_extensions), lang_key('installed'), lang_key('not_installed'));
        $validations['php_imagick'] = array(false, 'PHP Imagick', in_array('imagick', $loaded_extensions), lang_key('installed'), lang_key('not_installed'));
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="templates/<?php echo EI_TEMPLATE; ?>/css/styles.css?v=2" />
	<?php
