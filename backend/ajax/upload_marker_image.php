...
if (!file_exists(dirname(__FILE__).'/../../viewer/marker_images/')) {
    mkdir(dirname(__FILE__).'/../../viewer/marker_images/', 0775);
}
if(isset($_FILES) && !empty($_FILES['file']['name'])){
    ...
    if(in_array($ext,$allowed_ext)){
        ...
        $moved = move_uploaded_file($_FILES['file']['tmp_name'],dirname(__FILE__).'/../../viewer/marker_images/'.$name);
        if($moved) {
